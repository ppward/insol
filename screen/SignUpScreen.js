              ...
              <View style={styles.modalOverlay}>
                <View style={styles.modalView}>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor="#C7C7CD"
                  />
                  <TouchableOpacity onPress={handleSignUp}><View style={{width :150,height : 30,borderRadius : 8,backgroundColor : "#fff",alignItems : "center" , justifyContent:"center"}}><Text>회원가입</Text></View></TouchableOpacity>
                </View>
              </View>
            </TouchableWithoutFeedback>
          </Modal>
